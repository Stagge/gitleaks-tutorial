...
# Set up the demo repository for step 4
cd ~/demo-repo
...
echo "This is a demo application for testing Gitleaks." >> README.md
...
# Stage all files
git add .
git commit -m "Add demo files for Git hooks testing"

echo "Demo repository ready for Git hooks testing!"
